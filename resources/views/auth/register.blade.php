                  ...
                  <div class="auth-form-wrapper px-4 py-5">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" @error('name') is-invalid @enderror" required name="name" value="{{ old('name') }}" id="exampleInputUsername1" autocomplete="Username" placeholder="Username">
                        @error('name')
                      ...
                      <div class="form-group">
                        ...
                        <input type="email" @error('email') is-invalid @enderror" required name="email" value="{{ old('email') }}" class="form-control" id="exampleInputEmail1" placeholder="Email">
                        @error('email')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                      ...
                      <div class="form-group">
                        ...
                        <input type="password" class="form-control" @error('password') is-invalid @enderror" name="password" required id="exampleInputPassword1" autocomplete="current-password" placeholder="Password">
                        @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                      ...
                      <div class="mt-3">
                        <button type="submit" class="btn btn-primary text-white mr-2 mb-2 mb-md-0">Sing up</a>

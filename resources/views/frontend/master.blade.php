...
<!-- Mirrored from themezhub.net/kumo-demo-2/kumo/home-15.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 11:54:38 GMT -->
<head>
		<meta charset="utf-8" />
							...
							<div class="currency-selector dropdown js-dropdown float-right mr-3">
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu">
                                      ...
                                      <a href="{{ route('customer.logout') }}" class="dropdown-item" type="button">Logout</a>
                                    </div>
                                  </div>
                                @else
								<a href="{{ route('customer.register') }}" class="text-muted medium"><i class="lni lni-user mr-1"></i>Sign In / Register</a>
                                @endauth
							</div>
						...
						<div class="nav-header">
							...
							<div class="nav-menus-wrapper">
								<ul class="nav-menu">
									...
									<li><a href="{{ url('/') }}" class="pl-0">Home</a>
				...
				<div class="rightMenu-scroll">
					...
					<div class="right-ch-sideBar">
						...
						<div class="cart_select_items py-2">
							<!-- Single Item -->
                            @auth('customerlogin')
                            @foreach (App\Models\Cart::where('customer_id', Auth::guard('customerlogin')->user()->id)->get() as $cart)
			...
			<div class="w3-ch-sideBar w3-bar-block w3-card-2 w3-animate-right" style="display:none;right:0;" id="Cart">
				<div class="rightMenu-scroll">
					...
					<div class="right-ch-sideBar">
							...
							<div class="d-flex align-items-center justify-content-between br-bottom px-3 py-3">
                                <div class="cart_single d-flex align-items-center">
									...
									<div class="cart_single_caption pl-2">
										...
										<p class="mb-2"><span class="text-dark ft-medium small">{{ ($cart->size_id == null)?' ': $cart->rel_to_size->size }}</span>{{ ($cart->size_id == null)?' ':',' }}<span class="text-dark small">{{ ($cart->color_id == null)?'NA': $cart->rel_to_color->color_name }}</span></p>
						...
						<div class="cart_action px-3 py-3">
							<div class="form-group">
								<a href="{{ route('cart') }}" class="btn d-block full-width btn-dark">Checkout Now</a>
							</div>
							<div class="form-group">
								<button type="button" class="btn d-block full-width btn-dark-light">Edit or View</button>
							</div>
...
<!-- Mirrored from themezhub.net/kumo-demo-2/kumo/home-15.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 11:55:07 GMT -->
</html>

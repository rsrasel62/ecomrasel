                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col d-flex align-items-center justify-content-between">
                                <div class="cart_single_caption pl-2">
                                    ...
                                    <p class="mb-1 lh-1"><span class="text-dark">Size: {{ ($cart->size_id == null)?'null': $cart->rel_to_size->size }}</span></p>
                                    <p class="mb-3 lh-1"><span class="text-dark">Color: {{ ($cart->color_id == null)?'null': $cart->rel_to_color->color_name }}</span></p>
                    ...
                    <div class="col-12 col-md-7">
                        ...
                        <form class="mb-7 mb-md-0" action="{{ route('cart') }}" method="GET">
                            ...
                            <div class="row form-row">
                                ...
                                <div class="col-auto">
                                    <button type="submit" class="btn btn-dark" type="submit">Apply</button>
                                </div>
                            </div>
                            @if ($message)
                ...
                <div class="card mb-4 gray mfliud">
                  <div class="card-body">
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                      ...
                      @endif
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Discount , {{ $type }}</span> <span class="ml-auto text-dark ft-medium">TK{{ $discount }}</span>
                      </li>
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
